...
mlflow.set_experiment('diabetes-rf-hyp-tuning')
...
with mlflow.start_run():
    ...
    # Log best parameters and the best score
    mlflow.log_params(best_params)
    mlflow.log_metric('best_accuracy', best_score)

    # Log training and validation data for the best model
    ...
    mlflow.log_artifact(test_csv_path, 'test_data')
